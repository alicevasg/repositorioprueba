 ...
 * @author Alice Sugar
 */
public class Menu2A extends javax.swing.JPanel {
    DefaultTableModel modelo=new DefaultTableModel();
    Statement ejecutor=null;
    Connection conn;
    BaseDatos base = new BaseDatos();
    ITecnicoImpl CE = new ITecnicoImpl();
   ...
   DefaultTableModel modelo = new DefaultTableModel();
    ...
    try{
       ...
       while(rs.next()==true){
           datos[0] = rs.getString("ID2");
           datos[1] = rs.getString("fecharev");
           datos[2] = rs.getString("id_empress");
           datos[3] = rs.getString("tecnicos");
           datos[4] = rs.getString("funciona");
           modelo.addRow(datos);
        }
    ...
    private void initComponents() {
        ...
        tbl_buscar.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Numero de Revision", "Fecha", "ID Empresa", "Encargado", "Estado"
            }
        ));
        ...
        add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 530, 160, 30));
        ...
        add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 530, 190, 30));
        ...
        add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 30, 90, -1));
    ...
    String slq = "SELECT * FROM revisiones WHERE id2 LIKE '%"+busqueda+"%'";
    ...
    try{
        ...
        base.rs = base.sentencia.executeQuery(slq);
            ...
            while(base.rs.next()){
           datos[0] = base.rs.getString("id2");
           datos[1] = base.rs.getString("fecharev");
           datos[2] = base.rs.getString("id_empress");
           datos[3] = base.rs.getString("tecnicos");
           datos[4] = base.rs.getString("funciona");
                modelo.addRow(datos);
            }
