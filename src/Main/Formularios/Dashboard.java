...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_reguser.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 30, -1, -1));

        Menu.add(btn_reguser, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 520, 230, 70));
        ...
        btn_order.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 30, -1, -1));
...
// TODO add your handling code here:
    ...
    private void btn_tecno1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_tecno1MouseEntered
        if(btn_tecno1.getBackground().getRGB() == -15574355)
        setColor(btn_tecno1);
        // TODO add your handling code here:
    ...
    private void btn_tecno1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_tecno1MouseExited
        if(btn_order.getBackground().getRGB() != -15574355 ||btn_tecno.getBackground().getRGB() != -15574355 ||btn_empress.getBackground().getRGB() != -15574355 || btn_princ.getBackground().getRGB() != -15574355 || btn_reguser.getBackground().getRGB() != -15574355)
        resetColor(btn_tecno1);
        // TODO add your handling code here:
