 ...
 * @author Alice Sugar
 */
public class Mod1A extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 490, 210, 50));
    ...
    private void jPanel1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MousePressed
        Empresa e = new Empresa(trif.getText(), tname.getText(), tphone.getText(), tcity.getText(), tsurcursal.getText(), temail.getText(), tdirect.getText());
        IEmpresaImpl ie = new IEmpresaImpl();
        ie.actualizarEmpresa(trif.getText(),e);
