...
public class Mod3A extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 460, 210, 50));
    ...
    private void jPanel1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MousePressed
        Ordenes o = new Ordenes(t1.getText(),t2.getText(), t3.getText(), t4.getText(), t5.getText(), t6.getText(),t6.getText());
        IOrdenesImpl io = new IOrdenesImpl();
        io.actualizarOrdenes(t1.getText(),o);
