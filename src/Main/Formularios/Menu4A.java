 ...
 * @author Alice Sugar
 */
public class Menu4A extends javax.swing.JPanel {
    ...
    String query = "SELECT * FROM emptecnico";
    ...
    private void initComponents() {
        ...
        tbl_buscar.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "C.I.", "Nombre", "Apellido", "Telefono", "Email"
            }
        ));
        ...
        try {
            PreparedStatement elimina = conn.prepareStatement("DELETE FROM emptecnico WHERE id_empleado='"+valor+"'");
    ...
    String slq = "SELECT * FROM emptecnico WHERE id_empleado LIKE '%"+busqueda+"%'";
    ...
    try{
        ...
        base.rs = base.sentencia.executeQuery(slq);
            ...
            while(base.rs.next()){
           datos[0] = base.rs.getString("id_empleado");
           datos[1] = base.rs.getString("ci");
           datos[2] = base.rs.getString("nombre");
           datos[3] = base.rs.getString("apellido");
           datos[4] = base.rs.getString("telefono");
           datos[5] = base.rs.getString("email");
